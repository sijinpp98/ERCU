...
/* Private defines -----------------------------------------------------------*/
#define TIM2_CH2_HCSRO4_ECHO_Pin GPIO_PIN_1
#define TIM2_CH2_HCSRO4_ECHO_GPIO_Port GPIOA
#define TIM3_CH1_SERVO_PWM_Pin GPIO_PIN_6
#define TIM3_CH1_SERVO_PWM_GPIO_Port GPIOA
